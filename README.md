...
dotnet run
```
This app has 3 menus inside <b>Main Menu</b>: <b>User Menu</b>,<b> Trip Menu </b> and <b>StatisticsMenu </b>.

You can navigate through menus using numbers shown as part of each menu.Each number on those three menus leads to new submenu and so on.
<br/>
